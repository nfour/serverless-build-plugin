...
export default class ServerlessBuildPlugin {
    ...
    /**
     *  Babel transformer. ESX goes in, ES5 comes out
     *
     *  TODO:
     *      - Need to determine strategy for .babelrc options
     *          - Read for .babelrc, check for `this.config.babel`
     */
    async _babelTransform(file) {
     ...
     *
     *  TODO:
     *      - Use webpack against each file individually
     *      - OR, use uglifyjs on its own
     */
    async _minifyTransform(file) {
